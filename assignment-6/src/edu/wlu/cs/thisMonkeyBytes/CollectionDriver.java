...
public class CollectionDriver {
	 ...
	 * @param args
	 * 
	 * Tests MediaItem and its child classes using a map
	 */
	public static void main(String[] args) {
		...
		TreeMap<String, MediaItem> sortedCatalog = new TreeMap<>(catalog);
		
		System.out.println("\nSorting complete\n\nLIBRARY ORDER UPDATE");
		for (MediaItem i: sortedCatalog.values()) {
			System.out.println(i.getTitle());
		}
	}
